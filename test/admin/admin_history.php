...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf-Admin(history)</title>
  </head>
  ...
  <body>
    ...
    <table width="1000" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="center">
          <a href="../admin/admin_profile.php"><h3><font face="calibri" color="#444444">Admin</font></h3></a>
        </td>

        <td width="36" align="center">
          <a href="../admin/admin_profile.php"><img src="../res/ic_admin.png" alt="Admin Logo" width="22"></a>
        </td>
          ...
          <fieldset>
            <table width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  <a href="../admin/admin_dashboard.php"><h3><font face="calibri" color="#888888">Dashboard</font></h3></a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <a href="../admin/admin_history.html"><h3><font face="calibri" color="#444444">History</font></h3></a>
                </td>
              </tr>
            </table>
