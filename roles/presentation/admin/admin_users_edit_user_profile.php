...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf-Admin(edit user profile)</title>
  </head>
            ...
            <tr>
              <td colspan="4">
                <fieldset align="center">
                  <h3><font face="calibri" color="#444444">Edit User Profile</font></h3>
                </fieldset>
              </td>
            </tr>
                ...
                <form action="admin_users.php">
                  <table width="100%" cellspacing="10" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="45%">
                        <input name="profession" type="text" size="30" value="Machine Learning Engineer">
                      </td>
                    </tr>
