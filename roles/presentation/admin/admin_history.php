<?php require_once "../../control/admin/logincheck.php" ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf-Admin(history_login_times)</title>
  </head>
            ...
            <tr>
              <td width="14%">
                <a href="admin_history.php">
                  <h3><font face="calibri" color="#444444">Login Times</font></h3>
                </a>
              </td>
              ...
              <td width="14%" align="center">
                <a href="admin_history_purchases.php">
                  <h3><font face="calibri" color="#888888">Purchases</font></h3>
                </a>
              </td>
            ...
            <tr>
              <td colspan="4">
                <table border="1" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <th width="10%"><font face="calibri" color="#444444">SL.</font></th>
                    <th width="56%"><font face="calibri" color="#444444">Username</font></th>
                    <th width="34%"><font face="calibri" color="#444444">Last Login Time</font></th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <p><font face="calibri" color="#888888" size="4"><b>November 11, 2017 - 8am</b></font></p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <p><font face="calibri" color="#888888" size="4"><b>November 10, 2017 - 9am</b></font></p>
                    </td>
                  </tr>
