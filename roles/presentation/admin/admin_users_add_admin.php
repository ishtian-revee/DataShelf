      ...
      <tr height="400">
        ...
        <td valign="top">
          <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td colspan="4">
                <form name="add_admin_form" action="../../control/admin/add_admin_control.php" onsubmit="return validateForm()" method="POST">
                  <table width="100%" cellspacing="10" cellpadding="0">
                    ...
                    <tr>
                      <td colspan="2">
                        <fieldset>
                          ...
                          <input type="text" name="day" size="10">
                          <label><font face="calibri" color="#444444" size="4">/</font></label>
                          <input type="text" name="month" size="10">
                          <label><font face="calibri" color="#444444" size="4">/</font></label>
                          <input type="text" name="year" size="10">
                          <label>
                            <font face="calibri" color="#888888" size="4"><i>(dd/mm/yyyy)</i></font>
                          </label>
                        </fieldset>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2"><br><br><hr noshade="noshade"></td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <input type="password" name="confirm" size="35">
                      </td>
                    </tr>
