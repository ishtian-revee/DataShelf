...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf-Admin(post datasets details)</title>
  </head>
            ...
            <tr>
              <td colspan="2">
                <fieldset align="center">
                  <h3><font face="calibri" color="#444444">Dataset</font></h3>
                </fieldset>
              </td>
            </tr>
              ...
              <td colspan="2">
                <form action="admin_posts.php">
                  <table width="100%" cellspacing="0" cellpadding="8">
                    ...
                    <tr>
                      <td width="15%" valign="top">
                        <h3><font face="calibri" color="#444444">Downloads:</font></h3>
                      </td>

                      <td>
                        <p><font face="calibri" color="#888888" size="4"><b>79</b></font></p>
                      </td>
                    </tr>
