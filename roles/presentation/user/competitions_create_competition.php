...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf(competitions_create_competition)</title>
  </head>
          ...
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="16%" align="right">
                <a href="user/user_competitions_create_competition.php">
                  <h3><font face="calibri" color="#444444">Create Competition</font></h3>
                </a>
              </td>
            </tr>
            ...
            <tr>
              <td colspan="7" align="center">
                <h2><font face="calibri" color="#444444">Create A Competition</font></h2>
              </td>
            </tr>

            <tr>
              <td colspan="7">
                <form action="competitions.php">
                  <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td colspan="2">
                    ...
                    <tr>
                      <td colspan="2">
                        <h2><font face="calibri" color="#444444">Overview</font></h2>
                        <hr width="300" noshade="noshade" align="left">
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Description</b></font></p>
                        <textarea name="context" rows="12" cols="60"></textarea>
                      </td>

                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Evaluation</b></font></p>
                    ...
                    <tr>
                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Submission Files</b></font></p>
                        <textarea name="context" rows="12" cols="60"></textarea>
                      </td>

                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Timeline</b></font></p>
                        <textarea name="contents" rows="12" cols="60"></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Data Description</b></font></p>
                        <textarea name="context" rows="12" cols="60"></textarea>
                      </td>

                      <td width="50%">
                        <p><font face="calibri" color="#888888" size="4"><b>Prizes</b></font></p>
                        <textarea name="contents" rows="12" cols="60"></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2" align="right">
                        ...
                        <input type="submit" name="add_dataset" value="Create">
                      </td>
                    </tr>
                  </table>
                </form>
