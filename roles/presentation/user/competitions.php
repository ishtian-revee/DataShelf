...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf(competitions_active)</title>
      ...
      <tr>
        <td colspan="8">
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="6">
                <h3><font face="calibri" color="#888888">61 active competitions</font></h3>
              </td>
            ...
            <tr>
              <td width="9%" align="center">
                <a href="competitions.php">
                  <h4><font face="calibri" color="#444444">Active</font></h4>
                </a>
              </td>
