<?php
  ...
  require_once "../../control/profile_bought_items_controller.php";
?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf(user profile - bought items)</title>
            ...
            <tr>
              <td colspan="2">
                <table width="100%" align="center" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="10%" align="center">
                      <a href="profile_bought_items.php">
                        <h4><font face="calibri" color="#444444">Bought Items</font></h4>
                      </a>
                    </td>
                  ...
                  <tr>
                    <td colspan="10">
                      <h2><font face="calibri" color="#444444">Bought Items</font></h2>
