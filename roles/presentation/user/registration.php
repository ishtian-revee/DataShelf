...
<html>
  <head>
    <meta charset="utf-8">
    <title>DataShelf(registration)</title>
        ...
        <td colspan="8">
          ...
          <form name="signup_form" action="../../control/registration_control.php" onsubmit="return validateForm()" method="POST">
            <table width="400" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="20%">
                  <a href="login.php"><h2><font face="calibri" color="#888888">Log In</font></h2></a>
                </td>
                ...
                <td width="30%">
                  <a href="registration.php"><h2><font face="calibri" color="#444444">Sign Up</font></h2></a>
                </td>
              ...
              <tr>
                <td colspan="4">
                  ...
                  <h3><font face="calibri" color="#444444">Confirm Password</font></h3>
                  ...
                  <fieldset>
                    <legend><h3><font face="calibri" color="#444444">Gender</font></h3></legend>
                  ...
                  <fieldset>
                    <legend><h3><font face="calibri" color="#444444">Date of Birth</font></h3></legend>
                  ...
                  <label><font face="calibri" color="#888888" size="4"><b>I agree all the Terms and Services Policies.</b></font></label>
